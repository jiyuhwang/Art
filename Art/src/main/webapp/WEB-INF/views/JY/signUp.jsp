	...
	<div class="wrap">
			...
			<div class="user_wrap">
				...
				<div class="user_input_box">
					<input id="userInput" name="userName"  placeholder="이름 입력">
				</div>
			</div>
			<div class="sex_wrap">
			...
			<div class="phone_wrap">
				...
				<div class="phone_input_box">
					<input id="phoneInput" name="userPhone"  placeholder="010-****-****">
				</div>
			</div>
			<div class="birth_wrap">
				<div class="birth_name">생년월일</div>
				<div class="birth_input_box">
					<input type="text" id="birthYear" name="birthYear" placeholder="년(4자)" maxlength="4">
					<select name="birthMonth" class="birth_select">
		 			...
		 			<input type="text" id="birthDay" name="birthDay" placeholder="일" maxlength="2">			
				</div>
			</div>
			<div class="mail_wrap">
