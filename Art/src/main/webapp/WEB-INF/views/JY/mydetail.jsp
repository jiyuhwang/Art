...
<body>
	<div class="header">
		...
		<div id="searchW"><input type="text" id="btnSearch"></div>
	...
	<div class="wrap">
		...
		<!-- <div class="btn_edit_Delete">
			...
			<input type="button" id="btncontentsDelete" value="삭제하기">
		</div> -->
		<br />
		<br />
		...
		<div class="comment_wrap">
			...
			<div class="comment_form1">
				...
				<div id="comment1Date">2021.05.11.12:18 <a id="commentDeclation" href="#">신고하기</a></div>
			</div>
			<div class="btn_replyUpload_commentDelete_w">
			...
			<div class="comment_form1">
				...
				<div id="comment1Date">2021.05.12.13:20 <a id="commentDeclation" href="#">신고하기</a></div>
				<div class="btn_replyUpload_commentDelete_w">
					<input type="button" id="btnReplyUpload" value="답글">
					<input type="button" id="btnCommentDelete" value="삭제">
				</div>
