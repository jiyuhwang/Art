...
<head>
<meta charset="UTF-8">
<title>drawgallary</title>
<link rel="stylesheet" href="resources/css/JY/drawgallary.css">
...
<form action="#" id="actionForm" method="post">
	...
	<div class="wrap">
		<div class="gallary">
			<div class="tabs">
				<input id="gallaryMenu1" type="radio" name="tab"  />
				<input id="gallaryMenu2" type="radio" name="tab" checked="checked"/>
