...
<meta charset="UTF-8">
<title>gallary</title>
<link rel="stylesheet" href="resources/css/PJ/gallary.css">
				...
				<div id="tabs">
					...
					<div class="gly_menu1_ctt">
						<div class="pte_wrap">
							...
							<div class="pte" id="pte10"></div>
							<div class="pte" id="pte11"></div>
							<div class="pte" id="pte12"></div>
							<div class="pte" id="pte13"></div>
							<div class="pte" id="pte14"></div>
							<div class="pte" id="pte15"></div>
							<div class="pte" id="pte16"></div>
						</div>
					</div>
